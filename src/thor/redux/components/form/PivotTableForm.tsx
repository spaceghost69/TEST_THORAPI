...
const PivotTableForm: React.FC = () => {
  ...
  const initialValues: PivotTable = {
    ...
    id : '2b75cb97-577d-4c5f-a014-8af30267b51e',
    ...
    ownerId : 'b806f5d4-647e-4cb0-8b31-76feecb03cb3',
    ...
    lastAccessedById : 'd8f02c18-dcf4-42d9-a9b9-a1414ae4645f',
    ...
    lastModifiedById : 'febfbddb-501e-41c6-be55-61e7c6549acc',
  ...
  const handleSubmit = (values: FormikValues,
    { setSubmitting }: FormikHelpers<PivotTable>) => {
    setTimeout(() => {
      console.log(values);
      addPivotTable(values);
      setSubmitting(false);
    }, 500);
  }
          ...
          <form onSubmit={handleSubmit} className="form">
                    ...
                    >
                      ...
                      <Accordion.Item eventKey="1">
                        <Accordion.Header><FaRegPlusSquare  size={36}/> Add New PivotTable</Accordion.Header>
                        <Accordion.Body>
