...
const KeyMetricForm: React.FC = () => {
  ...
  const initialValues: KeyMetric = {
    ...
    id : 'd48355ce-9283-4437-a1d4-0665a3a9f9af',
    ...
    ownerId : 'ea06f45c-5d3a-4b1c-8952-187af6682e18',
    ...
    lastAccessedById : '51c25bf6-22ed-43a2-a0ce-3d157ebd2c28',
    ...
    lastModifiedById : 'c54babbc-7ef2-4c9f-a60e-a3c7f10cb2f3',
          ...
          <form onSubmit={handleSubmit} className="form">
                    ...
                    >
                      ...
                      <Accordion.Item eventKey="1">
                        <Accordion.Header><FaRegPlusSquare  size={36}/> Add New KeyMetric</Accordion.Header>
                        <Accordion.Body>
        ...
        {/* MUSTACHE FORM FIELDS */}
          ...
          {/* goalId  TEXT FIELD */}
            ...
            <label htmlFor="metricName" className="nice-form-control">
              <b>Metric Name: {touched.metricName && !errors.metricName && (<span className="okCheck"><FaCheckCircle /> looks good!</span>)}</b>
              
              
              
          
          {/* metricName  TEXT FIELD */}
              <Field name="metricName" type="text"
                className={errors.metricName  ? 'form-control field-error' : ' nice-form-control form-control'} />    
            ...
            <label htmlFor="metricValue" className="nice-form-control">
              <b>Metric Value: {touched.metricValue && !errors.metricValue && (<span className="okCheck"><FaCheckCircle /> looks good!</span>)}</b>
              
              
              
          
          {/*metricValue DATE FIELD */}
              <Field name="metricValue" type="date"
                className={errors.metricValue  ? 'form-control field-error' : ' nice-form-control form-control'} />
            ...
            <label htmlFor="targetValue" className="nice-form-control">
              <b>Target Value: {touched.targetValue && !errors.targetValue && (<span className="okCheck"><FaCheckCircle /> looks good!</span>)}</b>
              
              
              
          
          {/*targetValue DATE FIELD */}
              <Field name="targetValue" type="date"
                className={errors.targetValue  ? 'form-control field-error' : ' nice-form-control form-control'} />
