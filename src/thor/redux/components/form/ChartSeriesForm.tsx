...
const validationSchema = Yup.object().shape({
    ...
    .oneOf([true], "The showDataLabels value must be true.")
...
const ChartSeriesForm: React.FC = () => {
  ...
  const initialValues: ChartSeries = {
    ...
    id : '7d5500c9-c5f8-4793-85b8-651a5fb88cdf',
    ...
    ownerId : 'edd2e4b7-1a51-4b5f-a30b-d9c525f9ccdc',
    ...
    lastAccessedById : 'c21c9252-e081-4de6-86d4-80e3d98db0a5',
    ...
    lastModifiedById : '333b73e1-012e-4003-9132-ccea760ef222',
      ...
      >
          ...
          <form onSubmit={handleSubmit} className="form">
                    ...
                    >
                      ...
                      <Accordion.Item eventKey="1">
                        <Accordion.Header><FaRegPlusSquare  size={36}/> Add New ChartSeries</Accordion.Header>
                        <Accordion.Body>
        ...
        {/* MUSTACHE FORM FIELDS */}
            ...
            <label htmlFor="chartId" className="nice-form-control">
              <b>Chart Id: {touched.chartId && !errors.chartId && (<span className="okCheck"><FaCheckCircle /> looks good!</span>)}</b>
              
              
              
          
          {/* chartId  TEXT FIELD */}
              <Field name="chartId" type="text"
                className={errors.chartId  ? 'form-control field-error' : ' nice-form-control form-control'} />    
                        <ErrorMessage className='error' name="chartId" component="span" />
            </label>
          ...
          {/* name  TEXT FIELD */}
            ...
            <label htmlFor="valuesRange" className="nice-form-control">
              <b>Values Range: {touched.valuesRange && !errors.valuesRange && (<span className="okCheck"><FaCheckCircle /> looks good!</span>)}</b>
              
              
              
          
          {/* valuesRange  TEXT FIELD */}
              <Field name="valuesRange" type="text"
                className={errors.valuesRange  ? 'form-control field-error' : ' nice-form-control form-control'} />    
                        <ErrorMessage className='error' name="valuesRange" component="span" />
            </label>
          ...
          {/* color  TEXT FIELD */}
            ...
            <label htmlFor="markerStyle" className="nice-form-control">
              <b>Marker Style: {touched.markerStyle && !errors.markerStyle && (<span className="okCheck"><FaCheckCircle /> looks good!</span>)}</b>
              
              
              
          
          {/* markerStyle  TEXT FIELD */}
              <Field name="markerStyle" type="text"
                className={errors.markerStyle  ? 'form-control field-error' : ' nice-form-control form-control'} />    
                        <ErrorMessage className='error' name="markerStyle" component="span" />
            </label>


        
            <label htmlFor="showDataLabels" className="nice-form-control">
              <b>Show Data Labels: {touched.showDataLabels && !errors.showDataLabels && (<span className="okCheck"><FaCheckCircle /> looks good!</span>)}</b>
          ...
          {/* CHECKBOX FIELD */}
              ...
              <ErrorMessage className='error' name="showDataLabels" component="span" />
            </label>
