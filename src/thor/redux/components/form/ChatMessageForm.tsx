...
import { ChatMessage, ChatMessageSourceTypeEnum, ChatMessageRoleEnum,  } from '../../../model';
...
const validationSchema = Yup.object().shape({
    ...
    .oneOf([true], "The connected value must be true.")
...
const ChatMessageForm: React.FC = () => {
  ...
  const initialValues: ChatMessage = {
    ...
    id : '843865cf-aeeb-4e86-87a4-e6e6e4c0fa91',
    ...
    ownerId : '48318675-0de4-4cc0-9598-601df73c48b0',
    ...
    lastAccessedById : '9c13ea7e-7254-47bf-881a-a62740fc8742',
    ...
    lastModifiedById : 'a448f2ce-98d1-4871-9623-f7fdd6bd49b2',
          ...
          <form onSubmit={handleSubmit} className="form">
                    ...
                    >
                      ...
                      <Accordion.Item eventKey="1">
                        <Accordion.Header><FaRegPlusSquare  size={36}/> Add New ChatMessage</Accordion.Header>
                        <Accordion.Body>
        ...
        {/* MUSTACHE FORM FIELDS */}
          ...
          {/* sessionId  TEXT FIELD */}
            ...
            <label htmlFor="connected" className="nice-form-control">
              <b>Connected: {touched.connected && !errors.connected && (<span className="okCheck"><FaCheckCircle /> looks good!</span>)}</b>
