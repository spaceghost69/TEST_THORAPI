...
const LineItemForm: React.FC = () => {
  ...
  const initialValues: LineItem = {
    ...
    id : 'd4ee861b-2825-4ec0-8ebf-6f7881c69b2f',
    ...
    ownerId : '42f91743-5954-43c4-8b74-44f68a4e62a1',
    ...
    lastAccessedById : 'f195c339-cbda-4de6-b104-ecddab1a5201',
    ...
    lastModifiedById : 'cae5eedf-458a-49e8-80ab-6bd5eecedd8d',
  ...
  const handleSubmit = (values: FormikValues,
    { setSubmitting }: FormikHelpers<LineItem>) => {
    setTimeout(() => {
      console.log(values);
      addLineItem(values);
      setSubmitting(false);
      ...
      >
          ...
          <form onSubmit={handleSubmit} className="form">
                    ...
                    >
                      ...
                      <Accordion.Item eventKey="1">
                        <Accordion.Header><FaRegPlusSquare  size={36}/> Add New LineItem</Accordion.Header>
                        <Accordion.Body>
        ...
        {/* MUSTACHE FORM FIELDS */}
            ...
            <label htmlFor="salesOrderId" className="nice-form-control">
              <b>Sales Order Id: {touched.salesOrderId && !errors.salesOrderId && (<span className="okCheck"><FaCheckCircle /> looks good!</span>)}</b>
              
              
              
          
          {/* salesOrderId  TEXT FIELD */}
              <Field name="salesOrderId" type="text"
                className={errors.salesOrderId  ? 'form-control field-error' : ' nice-form-control form-control'} />    
          ...
          {/* productId  TEXT FIELD */}
            ...
            <label htmlFor="lineItemAmount" className="nice-form-control">
              <b>Line Item Amount: {touched.lineItemAmount && !errors.lineItemAmount && (<span className="okCheck"><FaCheckCircle /> looks good!</span>)}</b>
              
              
              
          
          {/*lineItemAmount DATE FIELD */}
              <Field name="lineItemAmount" type="date"
                className={errors.lineItemAmount  ? 'form-control field-error' : ' nice-form-control form-control'} />
                        <ErrorMessage className='error' name="lineItemAmount" component="span" />
            </label>
