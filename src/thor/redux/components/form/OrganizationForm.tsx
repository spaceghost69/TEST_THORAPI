...
const OrganizationForm: React.FC = () => {
  ...
  const initialValues: Organization = {
    ...
    id : '96040b16-458f-46f6-8a90-6b163b2d6e12',
    ...
    ownerId : '07c45e12-d2e8-49ed-9e26-192e868673bc',
    ...
    lastAccessedById : 'bbf6c89f-0f93-435f-871a-d2985bd90dbb',
    ...
    lastModifiedById : '2f3719a1-091e-47ab-89f9-9359e01e6feb',
  ...
  const handleSubmit = (values: FormikValues,
    { setSubmitting }: FormikHelpers<Organization>) => {
    setTimeout(() => {
      console.log(values);
          ...
          <form onSubmit={handleSubmit} className="form">
                    ...
                    >
                      ...
                      <Accordion.Item eventKey="1">
                        <Accordion.Header><FaRegPlusSquare  size={36}/> Add New Organization</Accordion.Header>
                        <Accordion.Body>
        ...
        {/* MUSTACHE FORM FIELDS */}
          ...
          {/* name  TEXT FIELD */}
            ...
            <label htmlFor="homePage" className="nice-form-control">
              <b>Home Page: {touched.homePage && !errors.homePage && (<span className="okCheck"><FaCheckCircle /> looks good!</span>)}</b>
          ...
          {/* homePage  TEXT FIELD */}
              <Field name="homePage" type="text"
                className={errors.homePage  ? 'form-control field-error' : ' nice-form-control form-control'} />    
            ...
            <label htmlFor="phone" className="nice-form-control">
              <b>Phone: {touched.phone && !errors.phone && (<span className="okCheck"><FaCheckCircle /> looks good!</span>)}</b>
          ...
          {/* phone  TEXT FIELD */}
              <Field name="phone" type="text"
                className={errors.phone  ? 'form-control field-error' : ' nice-form-control form-control'} />    
            ...
            <label htmlFor="addressId" className="nice-form-control">
              <b>Address Id: {touched.addressId && !errors.addressId && (<span className="okCheck"><FaCheckCircle /> looks good!</span>)}</b>
              
              
              
          
          {/* addressId  TEXT FIELD */}
              <Field name="addressId" type="text"
                className={errors.addressId  ? 'form-control field-error' : ' nice-form-control form-control'} />    
