...
import { useAddGameWeaponIDXMutation } from '../../services/GameWeaponIDXService';
...
const GameWeaponIDXForm: React.FC = () => {
  const [addGameWeaponIDX, addGameWeaponIDXResult] = useAddGameWeaponIDXMutation();

  const initialValues: GameWeaponIDX = {
    ...
    id : '4b37eb03-82c6-4146-8e5b-b715c165f580',
    ...
    ownerId : '80601c34-1c3e-4710-8527-a27c0737921f',
    ...
    lastAccessedById : '619a6ba7-3f15-49db-a680-86f9f804ba73',
    ...
    lastModifiedById : '44b24cd5-32de-49d0-a1e0-943507f98605',
  ...
  const handleSubmit = (values: FormikValues,
    { setSubmitting }: FormikHelpers<GameWeaponIDX>) => {
    setTimeout(() => {
      console.log(values);
      addGameWeaponIDX(values);
      setSubmitting(false);
    }, 500);
  }
    ...
    <div>
      ...
      >
                    ...
                    >
                      <Accordion.Item eventKey="0">
                        ...
                        <Accordion.Body>
                          ...
                          <br />
                          addGameWeaponIDXResult: {JSON.stringify(addGameWeaponIDXResult)}
                        </Accordion.Body>
                      </Accordion.Item>

                      <Accordion.Item eventKey="1">
                        <Accordion.Header><FaRegPlusSquare  size={36}/> Add New GameWeaponIDX</Accordion.Header>
                        <Accordion.Body>
        ...
        {/* MUSTACHE FORM FIELDS */}
            ...
            <label htmlFor="gameId" className="nice-form-control">
              <b>Game Id: {touched.gameId && !errors.gameId && (<span className="okCheck"><FaCheckCircle /> looks good!</span>)}</b>
              
              
              
          
          {/* gameId  TEXT FIELD */}
              <Field name="gameId" type="text"
                className={errors.gameId  ? 'form-control field-error' : ' nice-form-control form-control'} />    
                        <ErrorMessage className='error' name="gameId" component="span" />
            </label>


        
            <label htmlFor="weaponId" className="nice-form-control">
              <b>Weapon Id: {touched.weaponId && !errors.weaponId && (<span className="okCheck"><FaCheckCircle /> looks good!</span>)}</b>
              
              
              
          
          {/* weaponId  TEXT FIELD */}
              <Field name="weaponId" type="text"
                className={errors.weaponId  ? 'form-control field-error' : ' nice-form-control form-control'} />    
                        <ErrorMessage className='error' name="weaponId" component="span" />
            </label>
...
<br /><br />
                    ...
                    >
                      ...
                      <FaCheckCircle size={30} /> Create New GameWeaponIDX
                    </CoolButton>
...
export default GameWeaponIDXForm;
