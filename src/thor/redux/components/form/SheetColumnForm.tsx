...
const SheetColumnForm: React.FC = () => {
  ...
  const initialValues: SheetColumn = {
    ...
    id : '77a55166-cb74-4ec3-adc7-f29ed80a43b5',
    ...
    ownerId : '540b7fe7-60d6-43cf-bf2c-1ee832f404ea',
    ...
    lastAccessedById : 'b8dce1fa-0424-424d-b297-318d8a372d21',
    ...
    lastModifiedById : 'e18b65fc-a411-418a-9193-dfca46b499b1',
          ...
          <form onSubmit={handleSubmit} className="form">
                    ...
                    >
                      ...
                      <Accordion.Item eventKey="1">
                        <Accordion.Header><FaRegPlusSquare  size={36}/> Add New SheetColumn</Accordion.Header>
                        <Accordion.Body>
        ...
        {/* MUSTACHE FORM FIELDS */}
          ...
          {/* sheetId  TEXT FIELD */}
            ...
            <label htmlFor="colIndex" className="nice-form-control">
              <b>Col Index: {touched.colIndex && !errors.colIndex && (<span className="okCheck"><FaCheckCircle /> looks good!</span>)}</b>
              
              
          {/*colIndex INTEGER FIELD */}
              <Field name="colIndex" type="text"
                className={errors.colIndex  ? 'form-control field-error' : ' nice-form-control form-control'} />
          
              
                        <ErrorMessage className='error' name="colIndex" component="span" />
            </label>
