...
const CellForm: React.FC = () => {
  ...
  const initialValues: Cell = {
    ...
    id : '91a568a7-f93a-4924-9d82-20edaa321425',
    ...
    ownerId : '38f69281-33bd-4b77-873c-268cf819a3d5',
    ...
    lastAccessedById : 'a95c0ab5-2659-433f-a582-bba56b6e8d35',
    ...
    lastModifiedById : '7d6419c6-d9cd-4419-aa02-2634a43f0045',
          ...
          <form onSubmit={handleSubmit} className="form">
                    ...
                    >
                      ...
                      <Accordion.Item eventKey="1">
                        <Accordion.Header><FaRegPlusSquare  size={36}/> Add New Cell</Accordion.Header>
                        <Accordion.Body>
        ...
        {/* MUSTACHE FORM FIELDS */}
          ...
          {/* sheetId  TEXT FIELD */}
            ...
            <label htmlFor="comment" className="nice-form-control">
              <b>Comment: {touched.comment && !errors.comment && (<span className="okCheck"><FaCheckCircle /> looks good!</span>)}</b>
          ...
          {/* comment  TEXT FIELD */}
              <Field name="comment" type="text"
                className={errors.comment  ? 'form-control field-error' : ' nice-form-control form-control'} />    
            ...
            <label htmlFor="hyperlink" className="nice-form-control">
              <b>Hyperlink: {touched.hyperlink && !errors.hyperlink && (<span className="okCheck"><FaCheckCircle /> looks good!</span>)}</b>
          ...
          {/* hyperlink  TEXT FIELD */}
              <Field name="hyperlink" type="text"
                className={errors.hyperlink  ? 'form-control field-error' : ' nice-form-control form-control'} />    
                        <ErrorMessage className='error' name="hyperlink" component="span" />
            </label>


        
            <label htmlFor="sheetRowId" className="nice-form-control">
              <b>Sheet Row Id: {touched.sheetRowId && !errors.sheetRowId && (<span className="okCheck"><FaCheckCircle /> looks good!</span>)}</b>
              
              
              
          
          {/* sheetRowId  TEXT FIELD */}
              <Field name="sheetRowId" type="text"
                className={errors.sheetRowId  ? 'form-control field-error' : ' nice-form-control form-control'} />    
                        <ErrorMessage className='error' name="sheetRowId" component="span" />
            </label>


        
            <label htmlFor="sheetColumnId" className="nice-form-control">
              <b>Sheet Column Id: {touched.sheetColumnId && !errors.sheetColumnId && (<span className="okCheck"><FaCheckCircle /> looks good!</span>)}</b>
              
              
              
          
          {/* sheetColumnId  TEXT FIELD */}
              <Field name="sheetColumnId" type="text"
                className={errors.sheetColumnId  ? 'form-control field-error' : ' nice-form-control form-control'} />    
                        <ErrorMessage className='error' name="sheetColumnId" component="span" />
            </label>
