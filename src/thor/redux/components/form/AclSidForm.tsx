...
const AclSidForm: React.FC = () => {
  ...
  const initialValues: AclSid = {
    ...
    id : '04cd1d00-b4c5-49ec-8a58-a00c57c019e0',
    ...
    ownerId : 'aecace96-9b51-45cd-9abd-271b9efaccf0',
    ...
    lastAccessedById : '1e8b2125-23a7-4d15-b2f6-f8634de97252',
    ...
    lastModifiedById : '76ab4be8-d99f-42ee-a161-bd0275f4695b',
          ...
          <form onSubmit={handleSubmit} className="form">
                    ...
                    >
                      ...
                      <Accordion.Item eventKey="1">
                        <Accordion.Header><FaRegPlusSquare  size={36}/> Add New AclSid</Accordion.Header>
                        <Accordion.Body>
        ...
        {/* MUSTACHE FORM FIELDS */}
          ...
          {/* sid  TEXT FIELD */}
            ...
            <label htmlFor="principal" className="nice-form-control">
              <b>Principal: {touched.principal && !errors.principal && (<span className="okCheck"><FaCheckCircle /> looks good!</span>)}</b>
              
              
              
          
          {/* principal  TEXT FIELD */}
              <Field name="principal" type="text"
                className={errors.principal  ? 'form-control field-error' : ' nice-form-control form-control'} />    
                        <ErrorMessage className='error' name="principal" component="span" />
            </label>
