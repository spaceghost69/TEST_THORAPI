...
const OasObjectSchemaForm: React.FC = () => {
  ...
  const initialValues: OasObjectSchema = {
    ...
    id : 'cc53c734-b34a-4105-9635-57f3cd4a55ec',
    ...
    ownerId : '86d37cdb-41d3-4416-a764-5c6cc6208f98',
    ...
    lastAccessedById : 'ab8b3403-f4c6-47cc-af1d-f00004e908d4',
    ...
    lastModifiedById : '55615d7e-a87f-49b5-a696-e9bca3ee9d15',
  ...
  const handleSubmit = (values: FormikValues,
    { setSubmitting }: FormikHelpers<OasObjectSchema>) => {
    setTimeout(() => {
      console.log(values);
          ...
          <form onSubmit={handleSubmit} className="form">
                    ...
                    >
                      ...
                      <Accordion.Item eventKey="1">
                        <Accordion.Header><FaRegPlusSquare  size={36}/> Add New OasObjectSchema</Accordion.Header>
                        <Accordion.Body>
        ...
        {/* MUSTACHE FORM FIELDS */}
          ...
          {/* oasComponentsId  TEXT FIELD */}
            ...
            <label htmlFor="oasParameterId" className="nice-form-control">
              <b>Oas Parameter Id: {touched.oasParameterId && !errors.oasParameterId && (<span className="okCheck"><FaCheckCircle /> looks good!</span>)}</b>
              
              
              
          
          {/* oasParameterId  TEXT FIELD */}
              <Field name="oasParameterId" type="text"
                className={errors.oasParameterId  ? 'form-control field-error' : ' nice-form-control form-control'} />    
            ...
            <label htmlFor="oasResponseId" className="nice-form-control">
              <b>Oas Response Id: {touched.oasResponseId && !errors.oasResponseId && (<span className="okCheck"><FaCheckCircle /> looks good!</span>)}</b>
              
              
              
          
          {/* oasResponseId  TEXT FIELD */}
              <Field name="oasResponseId" type="text"
                className={errors.oasResponseId  ? 'form-control field-error' : ' nice-form-control form-control'} />    
          ...
          {/* type  TEXT FIELD */}
            ...
            <label htmlFor="format" className="nice-form-control">
              <b>Format: {touched.format && !errors.format && (<span className="okCheck"><FaCheckCircle /> looks good!</span>)}</b>
          ...
          {/* format  TEXT FIELD */}
              <Field name="format" type="text"
                className={errors.format  ? 'form-control field-error' : ' nice-form-control form-control'} />    
