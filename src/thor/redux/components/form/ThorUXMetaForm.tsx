...
const ThorUXMetaForm: React.FC = () => {
  ...
  const initialValues: ThorUXMeta = {
    ...
    id : '0ff01d7e-2649-432e-88e6-287fa1969905',
    ...
    ownerId : '944ea2a3-12c4-4c5e-9c2c-3ef894ff8fbb',
    ...
    lastAccessedById : '493d66f8-bb37-46be-9264-b9f092b0ea09',
    ...
    lastModifiedById : 'a94570b7-4765-4998-a2d2-796ad1b88258',
    ...
    <div>
      ...
      >
          ...
          <form onSubmit={handleSubmit} className="form">
                    ...
                    >
                      ...
                      <Accordion.Item eventKey="1">
                        <Accordion.Header><FaRegPlusSquare  size={36}/> Add New ThorUXMeta</Accordion.Header>
                        <Accordion.Body>
        ...
        {/* MUSTACHE FORM FIELDS */}
            ...
            <label htmlFor="thoruxComponents" className="nice-form-control">
              <b>Thorux Components: {touched.thoruxComponents && !errors.thoruxComponents && (<span className="okCheck"><FaCheckCircle /> looks good!</span>)}</b>
              
              
              
          
          {/* thoruxComponents  TEXT FIELD */}
              <Field name="thoruxComponents" type="text"
                className={errors.thoruxComponents  ? 'form-control field-error' : ' nice-form-control form-control'} />    
                        <ErrorMessage className='error' name="thoruxComponents" component="span" />
            </label>
