...
const OasOperationForm: React.FC = () => {
  ...
  const initialValues: OasOperation = {
    ...
    id : '7e182c0e-ba48-4b31-a0f6-ce7ccb41c71d',
    ...
    ownerId : '55ccff78-74ab-4b29-a41b-0ad569deb4d8',
    ...
    lastAccessedById : '7b88c52c-5ca4-4fd7-85f9-f9deab1acb6a',
    ...
    lastModifiedById : '5b1882b9-e088-4fb2-b3a6-0785a69dc3e3',
  ...
  const handleSubmit = (values: FormikValues,
    { setSubmitting }: FormikHelpers<OasOperation>) => {
    setTimeout(() => {
      console.log(values);
      addOasOperation(values);
      setSubmitting(false);
    }, 500);
  }
          ...
          <form onSubmit={handleSubmit} className="form">
                    ...
                    >
                      ...
                      <Accordion.Item eventKey="1">
                        <Accordion.Header><FaRegPlusSquare  size={36}/> Add New OasOperation</Accordion.Header>
                        <Accordion.Body>
        ...
        {/* MUSTACHE FORM FIELDS */}
          ...
          {/* description  TEXT FIELD */}
            ...
            <label htmlFor="oasPathId" className="nice-form-control">
              <b>Oas Path Id: {touched.oasPathId && !errors.oasPathId && (<span className="okCheck"><FaCheckCircle /> looks good!</span>)}</b>
              
              
              
          
          {/* oasPathId  TEXT FIELD */}
              <Field name="oasPathId" type="text"
                className={errors.oasPathId  ? 'form-control field-error' : ' nice-form-control form-control'} />    
                        <ErrorMessage className='error' name="oasPathId" component="span" />
            </label>
          ...
          {/* summary  TEXT FIELD */}
            ...
            <label htmlFor="operationId" className="nice-form-control">
              <b>Operation Id: {touched.operationId && !errors.operationId && (<span className="okCheck"><FaCheckCircle /> looks good!</span>)}</b>
              
              
              
          
          {/* operationId  TEXT FIELD */}
              <Field name="operationId" type="text"
                className={errors.operationId  ? 'form-control field-error' : ' nice-form-control form-control'} />    
                        <ErrorMessage className='error' name="operationId" component="span" />
            </label>
...
<br /><br />
                    ...
                    >
                      ...
                      <FaCheckCircle size={30} /> Create New OasOperation
                    </CoolButton>
