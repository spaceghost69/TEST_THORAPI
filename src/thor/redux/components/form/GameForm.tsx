...
import { useAddGameMutation } from '../../services/GameService';
...
const GameForm: React.FC = () => {
  ...
  const initialValues: Game = {
    ...
    id : '2fc54c12-6913-478e-a087-e2222bf27ea5',
    ...
    ownerId : '7d6f7412-2a3c-44f8-98be-b5b022b4829e',
    ...
    lastAccessedById : '537dbb10-653a-4599-9049-0bc65a86babb',
    ...
    lastModifiedById : '2e2698cb-2812-4af2-9835-0307fb620b25',
  ...
  const handleSubmit = (values: FormikValues,
    { setSubmitting }: FormikHelpers<Game>) => {
    setTimeout(() => {
      console.log(values);
      addGame(values);
      setSubmitting(false);
                    ...
                    >
                      <Accordion.Item eventKey="0">
                        ...
                        <Accordion.Body>
                          ...
                          <br />
                          addGameResult: {JSON.stringify(addGameResult)}
                        </Accordion.Body>
                      </Accordion.Item>

                      <Accordion.Item eventKey="1">
                        <Accordion.Header><FaRegPlusSquare  size={36}/> Add New Game</Accordion.Header>
                        <Accordion.Body>
...
<br /><br />
                    ...
                    >
                      ...
                      <FaCheckCircle size={30} /> Create New Game
                    </CoolButton>
