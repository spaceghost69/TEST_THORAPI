...
import { DataObject, Product } from '../../../model';
import { useLazyGetProductsQuery, useAddProductMutation, useUpdateProductMutation } from '../../services/ProductService';
...
const ProductTable: React.FC = () => {
  const [trigger, { data: newData = [], isFetching }] = useLazyGetProductsQuery();
  ...
  const [copiedRow, setCopiedRow] = useState<Product | null>(null);
