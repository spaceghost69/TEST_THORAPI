...
import { DataObject, Customer } from '../../../model';
import { useLazyGetCustomersQuery, useAddCustomerMutation, useUpdateCustomerMutation } from '../../services/CustomerService';
...
const CustomerTable: React.FC = () => {
  const [trigger, { data: newData = [], isFetching }] = useLazyGetCustomersQuery();
  ...
  const [copiedRow, setCopiedRow] = useState<Customer | null>(null);
  ...
  const handleSave = async (editKey: string) => {
    ...
    try {
      await updateCustomer(updatedItem).unwrap();
