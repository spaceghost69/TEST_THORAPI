...
import { DataObject, Stack } from '../../../model';
import { useLazyGetStacksQuery, useAddStackMutation, useUpdateStackMutation } from '../../services/StackService';
...
const StackTable: React.FC = () => {
  const [trigger, { data: newData = [], isFetching }] = useLazyGetStacksQuery();
