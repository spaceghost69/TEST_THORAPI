...
import { DataObject, Role } from '../../../model';
import { useLazyGetRolesQuery, useAddRoleMutation, useUpdateRoleMutation } from '../../services/RoleService';
...
const RoleTable: React.FC = () => {
  const [trigger, { data: newData = [], isFetching }] = useLazyGetRolesQuery();
