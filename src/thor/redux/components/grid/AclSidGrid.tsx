...
import AclSidChart from '../chart/AclSidChart';
import AclSidForm from '../form/AclSidForm';
  ...
  return (
    ...
    <Tabs key={'AclSid'}>
        ...
        <Tab
             title="AclSid" 
             eventKey="AclSidC" 
             active={ activeTab == 'AclSid' }
        >
              <AclSidChart /> 
          </Tab>
          
          <Tab title='New AclSid'
                  eventKey="AclSidN"
          >
              <AclSidForm />
          </Tab>
