...
import AclClassChart from '../chart/AclClassChart';
import AclClassForm from '../form/AclClassForm';
  ...
  return (
    ...
    <Tabs key={'AclClass'}>
        ...
        <Tab
             title="AclClass" 
             eventKey="AclClassC" 
             active={ activeTab == 'AclClass' }
        >
              <AclClassChart /> 
          </Tab>
          
          <Tab title='New AclClass'
                  eventKey="AclClassN"
          >
              <AclClassForm />
          </Tab>
