...
import DependChart from '../chart/DependChart';
import DependForm from '../form/DependForm';
  ...
  return (
    ...
    <Tabs key={'Depend'}>
        ...
        <Tab
             title="Depend" 
             eventKey="DependC" 
             active={ activeTab == 'Depend' }
        >
              <DependChart /> 
          </Tab>
          
          <Tab title='New Depend'
                  eventKey="DependN"
          >
              <DependForm />
          </Tab>
